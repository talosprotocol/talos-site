...
import { ChevronRight, Shield, Cpu, Zap, ExternalLink } from "lucide-react";
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="py-16 px-6 max-w-6xl mx-auto border-t border-gray-200 grid md:grid-cols-3 gap-10">
         {[
           { Icon: Cpu, label: "Problem", value: product.problem },
           { Icon: Zap, label: "Outcome", value: product.outcome },
           { Icon: ExternalLink, label: "Target Audience", value: product.audience }
