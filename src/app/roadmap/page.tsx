        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
           ...
           <div className="p-8 border rounded-2xl bg-white shadow-sm ring-1 ring-slate-100">
               <div className="flex items-center justify-between mb-6">
                   <h2 className="text-2xl font-bold text-slate-900">v1.1: Foundation</h2>
                   <span className="px-3 py-1 bg-green-100 text-green-700 text-sm font-bold rounded-full">LIVE</span>
               </div>
               <ul className="space-y-4 text-slate-600">
                   <li className="flex items-start gap-3">
                       <span className="text-green-500 mt-1">✓</span>
                       <span><strong>Talos Dashboard:</strong> Self-hosted audit explorer</span>
                   </li>
                   <li className="flex items-start gap-3">
                       <span className="text-green-500 mt-1">✓</span>
                       <span><strong>SDK Parity:</strong> TypeScript & Python runtimes</span>
                   </li>
                   <li className="flex items-start gap-3">
                       <span className="text-green-500 mt-1">✓</span>
                       <span><strong>Protocol:</strong> Double Ratchet + X3DH</span>
                   </li>
                   <li className="flex items-start gap-3">
                       <span className="text-green-500 mt-1">✓</span>
                       <span><strong>Transport:</strong> HTTP Polling (Firewall friendly)</span>
                   </li>
               </ul>
           </div>
            ...
            <div className="p-8 border border-blue-100 rounded-2xl bg-blue-50/50 relative overflow-hidden">
               ...
               <div className="flex items-center justify-between mb-6 relative z-10">
                   <h2 className="text-2xl font-bold text-blue-900">v1.2: Scale</h2>
                   <span className="px-3 py-1 bg-blue-100 text-blue-700 text-sm font-bold rounded-full">Q2 2026</span>
               </div>
               <ul className="space-y-4 text-slate-600 relative z-10">
                   <li className="flex items-start gap-3">
                       <span className="text-blue-500 mt-1">▸</span>
                       <span><strong>Streaming:</strong> Real-time WebSockets</span>
                   </li>
                   <li className="flex items-start gap-3">
                       <span className="text-blue-500 mt-1">▸</span>
                       <span><strong>Compliance:</strong> Bulk Export Jobs (CSV/JSON)</span>
                   </li>
                   <li className="flex items-start gap-3">
                       <span className="text-blue-500 mt-1">▸</span>
                       <span><strong>Identity:</strong> Rotation & Revocation UI</span>
                   </li>
               </ul>
            </div>
        </div>
